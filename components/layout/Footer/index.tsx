    ...
    <footer className="relative mt-6 py-6 md:py-10 lg:py-20 after:bg-[url('/assets/images/footer-bg-mob.svg')] lg:after:bg-[url('/assets/images/footer-bg.svg')] after:absolute after:content-[''] after:w-full after:h-full after:bottom-0 after:z-0 after:bg-no-repeat after:bg-cover">
      <div className="container mx-auto px-5 flex flex-col gap-6 lg:flex-row relative z-10 mt-20 lg:mt-0">
        <div className="self-center lg:basis-2/6 lg:flex lg:flex-col lg:items-center lg:gap-10">
          <Link href={getHomeRoute(locale)} className="md:scale-125">
        ...
        <div className="grid grid-cols-2 gap-6 lg:grid-cols-5 text-white lg:basis-4/6">
          <div>
            <ul className="flex flex-col gap-2 md:gap-4">
              {/* <li>
                <Link href={getHomeRoute(locale)}>Home</Link>
              </li> */}
              {/* <li>
                <Link href={getHomeRoute(locale)}>NGen for</Link>
              </li> */}
              <li>
                <Link href={getAboutRoute(locale)}>About us</Link>
              </li>
              <li>
                <Link href={getTracksRoute(locale)}>Tracks</Link>
              </li>
              {/* <li>
                <Link href={getInstructorsRoute(locale)}>Instructors</Link>
              </li> */}

              {/* TODO: To be deleted when we put the other list down below */}
              <li>
                <Link href={getPoliciesRoute(locale)}>Policies</Link>
              </li>
            </ul>
          </div>
          {/* <div>
            <ul className="flex flex-col gap-2 md:gap-4">
              <li>
                <Link href={getHomeRoute(locale)}>Blogs</Link>
              </li>
              <li>
                <Link href={getHomeRoute(locale)}>FAQs</Link>
              </li>
              <li>
                <Link href={getPoliciesRoute(locale)}>Policies</Link>
              </li>
          ...
          <div className="col-span-2 lg:col-span-1">
            <ul className="flex flex-col gap-2 md:gap-4 ">
              <li>
                <Link href={getNgenForSchoolsRoute(locale)}>For schools</Link>
              </li>
              <li>
                <Link href={getNgenForCorporatesRoute(locale)}>For corporates</Link>
              </li>
              <li>
                <Link href={getNgenForParentsRoute(locale)}>For parents</Link>
              </li>
              {/* <li>
                <Link href={getHomeRoute(locale)}>For individual</Link>
              </li> */}
            </ul>
          </div>
