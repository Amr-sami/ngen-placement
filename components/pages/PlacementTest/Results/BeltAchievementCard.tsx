            ...
            <div className="relative group">
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center p-4">
                  ...
                  <span
                    className="text-sm md:text-2xl font-black uppercase tracking-widest"
                    style={{ color: belt.textColor }}
                  >
                    {belt.belt}
                  </span>
        ...
        <div className="lg:col-span-7 p-6 md:p-12 bg-black/30 backdrop-blur-md flex flex-col justify-center">
          ...
          <div className="mt-8 md:mt-12 p-5 md:p-8 rounded-[2rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 relative group">
            ...
            <p className="text-slate-300 text-sm md:text-lg leading-relaxed italic">
              &ldquo;Based on your score of <span className="text-white font-bold">{score}</span>, our AI suggests starting at the <span className="text-white font-bold">{belt.belt} level</span> to ensure you have a strong foundation before moving to complex projects.&rdquo;
            </p>
          </div>
        </div>
      </div>
